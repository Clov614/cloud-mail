const en = {
    ...
    notSet: 'Not Set',
    deleteApiKey: 'Delete',
    deleteApiKeyConfirm: 'Are you sure you want to delete this key? This action cannot be undone.',
    enterDescription: 'Enter key description',
    descriptionRequired: 'Description is required',
    setExpiresTime: 'Set Expiration Time',
    selectExpiresTime: 'Select Expiration Time',
    neverExpire: 'Never Expire',
    apiKeyGenerated: 'API Key Generated',
    apiKeyWarning: 'This is the only time you will see this key. Please copy it immediately and store it securely. A leaked key will compromise your account security.',
    iHaveCopied: 'I Have Copied',
    generateApiKeyFailed: 'Failed to generate API Key',
    loadApiKeysFailed: 'Failed to load API Keys',
    deleteApiKeySuccess: 'Deleted successfully',
